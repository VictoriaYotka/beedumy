        ...
        <ul className={css.list}>
          <li className={css.item}>
            ...
            <div className={css.wrapper}>
              ...
              <p className={css.descr}>
                للتمتّع بمحتوى منصة بيرسا التعليمية نبدأ اولا بانشاء حساب خاص بك
                واختيار أحد العروض المتوفّرة ولإتمام عملية الدفعيمكنك زيارة
          ...
          <li className={css.item}>
            ...
            <div className={css.wrapper}>
              ...
              <p className={css.descr}>
                هي منصة تفاعلية موجهة إلى العالم العربي توفر مواد تعليمية لجميع
                الفئات العمرية ودورات تكوينية في تخصصات مختلفة بطريقة حديثة
                وفعالة
              </p>
            </div>
          </li>
          <li className={css.item}>
            ...
            <div className={css.wrapper}>
              ...
              <p className={css.descr}>
                للتسجيل في منصة بيرسا التعليمية أدخل للواجهة الرئيسية من الموقع
